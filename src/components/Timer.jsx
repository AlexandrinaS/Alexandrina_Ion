...
export const Countdown = ({ targetDate }) => {
    ...
    return (
        ...
        <div style={{padding: '0 8px'}}>
            <h2 style={{marginBottom: "-12px", fontSize: '20px'}}>Detaliu important:</h2>
            <p style={{fontSize: '20px'}}>Dacă vremea ne va permite, vom sărbători în aer liber. Serile de mai pot fi răcoroase, așa că vă recomandăm să luați o jachetă sau o păturică.</p>
        </div>
